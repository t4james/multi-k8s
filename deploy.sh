...
docker build -t t4james/multi-server:latest -t t4james/multi-server:$SHA -f ./client/Dockerfile ./server
docker build -t t4james/multi-worker:latest -t t4james/multi-worker:$SHA -f ./client/Dockerfile ./worker
